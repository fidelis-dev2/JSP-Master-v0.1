// Lab 07: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab07;
...
public class Lab07Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 07");
        request.setAttribute("message", "Hii ni practice ya somo 07. Andika version yako mwenyewe.");
