// Lab 01: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab01;
...
public class Lab01Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 01");
        request.setAttribute("message", "Hii ni practice ya somo 01. Andika version yako mwenyewe.");
