// Lab 42: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab42;
...
public class Lab42Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 42");
        request.setAttribute("message", "Hii ni practice ya somo 42. Andika version yako mwenyewe.");
