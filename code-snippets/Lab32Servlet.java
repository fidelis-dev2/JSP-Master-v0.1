// Lab 32: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab32;
...
public class Lab32Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 32");
        request.setAttribute("message", "Hii ni practice ya somo 32. Andika version yako mwenyewe.");
