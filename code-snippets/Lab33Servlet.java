// Lab 33: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab33;
...
public class Lab33Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 33");
        request.setAttribute("message", "Hii ni practice ya somo 33. Andika version yako mwenyewe.");
