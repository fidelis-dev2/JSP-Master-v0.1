// Lab 05: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab05;
...
public class Lab05Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 05");
        request.setAttribute("message", "Hii ni practice ya somo 05. Andika version yako mwenyewe.");
