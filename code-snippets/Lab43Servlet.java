// Lab 43: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab43;
...
public class Lab43Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 43");
        request.setAttribute("message", "Hii ni practice ya somo 43. Andika version yako mwenyewe.");
