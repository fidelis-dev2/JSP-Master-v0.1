// Lab 06: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab06;
...
public class Lab06Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 06");
        request.setAttribute("message", "Hii ni practice ya somo 06. Andika version yako mwenyewe.");
