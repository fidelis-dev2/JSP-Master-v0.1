// Lab 23: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab23;
...
public class Lab23Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 23");
        request.setAttribute("message", "Hii ni practice ya somo 23. Andika version yako mwenyewe.");
