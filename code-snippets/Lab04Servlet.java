// Lab 04: Jakarta JSP/Servlet practice
// Goal: Badilisha path, ongeza validation, na u-run kwenye Tomcat 10.1.

package tz.shotto.practice.lab04;
...
public class Lab04Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Lab 04");
        request.setAttribute("message", "Hii ni practice ya somo 04. Andika version yako mwenyewe.");
